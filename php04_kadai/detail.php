...
// ログインチェック処理(funcs.php内のloginCheck()関数を使う)
loginCheck();
...
// データが見つからない場合の処理
if (!$result) {
    echo "<script>alert('該当するデータが見つかりませんでした。入力内容を確認してください。'); location.href='login.php';</script>";
    exit();
}
?>
    ...
    <div class="container">
        ...
        <form action="update.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="pw" placeholder="半角英数字でパスワードを設定してください" required>
            </div>
