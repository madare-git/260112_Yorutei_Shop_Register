...
$stmt = $pdo->prepare("INSERT INTO 
                        Shop_table(lid, lpw, shop_name, repre_name, phone, email, address, genre, children, allergy, date) 
                        VALUES(:lid, :lpw, :shop_name, :repre_name, :phone, :email, :address, :genre, :children, :allergy, now() )");
...
<body>
    <div class="container">
        ...
        <ul class="nav-links">
            ...
            <li><a href="login.php" class="btn-back">ログイン</a></li>
        </ul>
    </div>
</body>
</html>
