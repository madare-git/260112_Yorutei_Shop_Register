...
<body>
    ...
    <div class="container">
        <h1>よる定 店舗情報照会</h1>
        <p style="text-align: center; color: #666; margin-bottom: 30px;">ID、パスワードを入力し、ログインしてください</p>
        
        <form method="post" action="login_act.php">
            
            <div style="margin-bottom: 30px;">
                <label style="display: block; margin-bottom: 8px; font-weight: bold; color: #333;">ID（登録メールアドレス）</label>
                <input type="email" name="lid" placeholder="例: example@email.com" required
                       style="width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 8px; box-sizing: border-box;">
            </div>

            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: bold; color: #333;">パスワード</label>
                <input type="text" name="lpw" placeholder="半角英数字で入力してください" required 
                       style="width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 8px; box-sizing: border-box;">
            </div>
